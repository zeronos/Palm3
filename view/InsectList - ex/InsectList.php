        ...
        <div class="row">
            <div class="col-xl-12 col-12 mb-4">
                <div class="card-header card-bg">
                    <div class="row">
                        <div class="col-12">
                            <span class="link-active" style="padding-top:20px;color:#006664">รายชื่อแมลง</span>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow" align="right">
                        ...
                        <button type="button" class="btn btn-warning btn-sm btn_edit" 
                            ...
                            charstyle="<?php echo $row["Charactor"]; ?>" 
                            dangerstyle="<?php echo $row["Danger"]; ?>" 
                            data-icon="<?php echo $row["Icon"]; ?>" 
                            numPicChar="<?php echo $row["NumPicChar"]; ?>" 
                            numPicDanger="<?php echo $row["NumPicDanger"]; ?>">
                            <i class="fas fa-edit"></i></button>

                        <button type="button" class="btn btn-danger btn-sm" 
                        onclick="delfunction('<?php echo $row["PID"]; ?>' , '<?php echo $row["Alias"]; ?>')">
                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" id="silder">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            src=<?php echo  $src = "../../picture/Pest/insect/style/" . $row["PID"] . "/" . $row["Icon"]; ?> 
                                            style="height:200px;">
                                        ...
                                        <?php for ($style_index = 0; $style_index < $row["NumPicChar"] - 1; $style_index++) { ?>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" 
                                                src=<?php echo  $src = "../../picture/Pest/insect/style/" . $row["PID"] . "/" . $style_index . "_" . $row["Icon"]; ?> 
                                                style="height:200px;">
                                            </div>
                                        <?php } ?>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                ...
                                <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel" id="silder">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" 
                                                src=<?php echo  $src = "../../picture/Pest/insect/danger/" . $row["PID"] . "/" . $row["Icon"]; ?> 
                                                style="height:200px;">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-12 mb-4 item.card" id="itemInsectCard" >
                    <div id=<?php echo $row["PID"]; ?> 
                        class="card card-item border-left-primary card-color-three shadow h-100 py-2 item">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" 
                                    style="text-align: center;">
                                    <img src=<?php echo $src = "../../icon/pest/".$row["PID"]."/".$row["Icon"]; ?> 
                                        width="100" height="100" alt="User" style="border-radius: 100px;">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 card-pest" 
                                    id="changeInsect">
                                    <h6 style="color:#006664"><br>
                                    <?php echo $row["Alias"]; ?></br>
                                    </h6>
                                </div>
                            </div>
                        </div>
