                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <span style="float:right;">
                                ...
                                <span> > </span>
                                <a class="link-path link-active"  style="color: #006664;" href="#">รายละเอียดการล้างคอขวด</a>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content" id="myTabContent" style="margin-top:20px;">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-bordered table-data" width="100%">
                                    <thead>
                                        <tr>
                                            <th>ชื่อแปลง</th>
                                            <th>วันที่</th>
...
<script>
    ...
    let nfarm = "<?php echo $farm[1]['Name']; ?>";
    let year = "<?php echo $year; ?>";
    // console.log(year+" "+nfarm)
    loadData()
    function loadData() {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (i in data) {
                    text += ` <tr>
                            ...
                            <td style="text-align:center;">${data[i].Date3}</td>
                            <td style="text-align:center;">
        ...
        xhttp.send(`name=${nfarm}&year=${year}`);
    }
