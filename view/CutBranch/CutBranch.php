        ...
        <div class="col-xl-12 col-12 mb-4">
            <div class="card">
                <div class="card-header card-bg">
                    <div class="row">
                        <div class="col-12">
                            <span class="link-active" style="color: #006664;">ล้างคอขวด</span>
                            <span style="float:right;  ">
                                <i class="fas fa-bookmark"></i>
                                <a class="link-path" href="#">หน้าแรก</a>
                                <span> > </span>
                                <a class="link-path link-active" style="color: #006664; href="#">ล้างคอขวด</a>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-bordered table-data" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>ชื่อเกษตรกร</th>
                                    <th>ชื่อสวน</th>
    ...
    function loadData(year, data_search) {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (i in data) {
                    if(data[i].note == null){
                        styleColor = ' style="background-color: #858796; border: 2px solid #858796;" '
                    }else{
                        styleColor =""
                    }
                    text += ` <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                <button type="button" id='${i}' Pid='${data[i].ID}' ${styleColor} class="btn btn-primary btn-sm btn-note" data-toggle="modal" data-target="#modal-3"><i class="far fa-sticky-note"></i></button>
                                    
                                <a href="CutBranchDetail.php?farmerID=${data[i].farmerID}&farmID=${data[i].FMID}&subfarmID=${data[i].FSID}&year=${data[i].year}"><button type="button" id="btn_info" class="btn btn-info btn-sm"><i class="fas fa-bars"></i></button></a>
                            </td>
                        </tr>`
                }
