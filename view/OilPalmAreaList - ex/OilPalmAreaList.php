...
<div class="container">
    ...
    <?php function creatCard( $styleC, $headC, $textC, $iconC ) { ?>
        <div class="col-xl-3 col-12 mb-4">
            <div class="card <?php echo $styleC;?> card-color-one shadow h-100 py-2">
                <div class="card-body">
                ...
                ?>
                    ...
                    <div class="card-body" style="background-color: white; ">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-xl-6 col-12">
                                <select id="s_" name="s_subdistrinct" class="form-control">
                ...
                <table class="table table-bordered table-data" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php for($i=0;$i<$numD;$i++) { ?>
                        <tr>
                            ...
                            <td align="center">
                                <a href='OilPalmAreaListDetail.php?id=${data[i].Name}&fname=${data[i].Alias}&fmid=${data[i].FMID}&logid=${data[i].ID}'>
