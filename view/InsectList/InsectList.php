                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" id="silder">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            src='<?php echo "../../picture/Pest/insect/style/" .$INFO["PID"]."/".$INFO["Icon"]; ?>' 
                                            style="height:200px;">
                                        ...
                                        <?php for ($style_index = 0; $style_index < $INFO["NumPicChar"]-1; $style_index++) { ?>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" 
                                                src='<?php echo "../../picture/Pest/insect/style/".$INFO["PID"]."/".$style_index."_".$INFO["Icon"]; ?> '
                                                style="height:200px;">
                                            </div>
                                        <?php } ?>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                ...
                                <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel" id="silder">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" 
                                                src='<?php echo "../../picture/Pest/insect/danger/".$INFO["PID"]."/".$INFO["Icon"]; ?> '
                                                style="height:200px;">
                                        ...
                                        <?php for ($danger_index = 0; $danger_index <$INFO["NumPicDanger"]-1; $danger_index++) { ?>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" 
                                                src='<?php echo "../../picture/Pest/insect/danger/".$INFO["PID"]."/".$danger_index."_".$INFO["Icon"]; ?>' 
                                                style="height:200px;">
                                            </div>
                                        <?php } ?>
                                    </div>
