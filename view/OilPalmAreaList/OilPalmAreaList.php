...
<div class="container">
    ...
    <?php 
        ...
        creatCard( "card-color-one",   "จำนวนสวน",  $farm1['totalFarm']." สวน ".$sfarm1['totalSubfarm']." แปลง", "group" );
        creatCard( "card-color-two",   "พื้นที่ทั้งหมด", $rai1['sumRai']." ไร่", "dashboard" );
        creatCard( "card-color-three", "จำนวนต้น",  $tree1['sumTree']." ต้น", "format_size" );
    ?>
        <div class="col-xl-3 col-12 mb-4">
