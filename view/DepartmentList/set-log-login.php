...
function NewLogLogin()
{
    ...
    $sql = "SELECT * FROM `dim-user` WHERE dbID='" . $DATA[1]['UID'] . "' AND Type='U' AND Title='" . $DATA[1]['Title'] . "' AND FullName ='" . $DATA[1]['FirstName'] . " " . $DATA[1]['LastName'] . "' AND Alias = '" . $DATA[1]['FirstName'] . "' ";
